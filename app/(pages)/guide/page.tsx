	...
	const steps = [
		{
			...
			text: (
				<div>
					Go to{" "}
					<a
						href="https://www.calligraphr.com/en/webapp/app_home/"
	...
	return (
		<div className="min-h-screen bg-white">
			...
			<div
				...
				style={{
					backgroundImage: "url('/imgs/texture-bg.webp')",
